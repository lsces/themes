	...
	{legend legend="Layout help"}
		{if $page eq "layout_overview"}
			<div class="form-group">
				...
				{forminput}
					{if !$smarty.request.nocollapse|default:false}
						<a href="{$smarty.const.KERNEL_PKG_URL}admin/index.php?page={$page}&amp;nocollapse=1">{biticon ipackage="icons" iname="list-add" iexplain="Expand all modules"}</a>
					{else}
						<a href="{$smarty.const.KERNEL_PKG_URL}admin/index.php?page={$page}">{biticon ipackage="icons" iname="list-remove" iexplain="Collapse all modules"}</a>
					{/if}
			...
			<div class="form-group">
				...
				{forminput}
					<a href="{$smarty.const.KERNEL_PKG_URL}admin/index.php?page={$page}&amp;fixpos=1">{biticon ipackage="icons" iname="go-next" iexplain="Adjust module postitions"}</a>
