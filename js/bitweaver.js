...
BitBase = {
	...
	//				<script> flipMulti('{$header}',1,2); </script>
	...
	*/
	...
	// usage:		<a href="<URL>" title="Opens link in new window" onkeypress="popUpWin(this.href,'standard',600,400);" onclick="popUpWin(this.href,'standard',600,400);return false;">FooBar</a>
